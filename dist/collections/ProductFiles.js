        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFileIds = products.map(function (ele) { return ele.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            depth: 2,
                            where: {
...
exports.ProductFiles = {
    ...
    access: {
        ...
        }, //only allow for admins, once you upload product files normal users cant change it
        delete: function (_a) {
            var req = _a.req;
            return req.user.role === "admin";
        },
